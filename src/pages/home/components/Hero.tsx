      ...
      <div className="relative z-10 w-full px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center lg:text-left lg:max-w-2xl">
            ...
            >
              Terapia Psicológica
              <span className="block text-white">Personalizada</span>
            </h2>
            ...
            >
              Ofrezco atención psicológica profesional y empática para ayudarte a encontrar el bienestar emocional que buscas.
            </p>
